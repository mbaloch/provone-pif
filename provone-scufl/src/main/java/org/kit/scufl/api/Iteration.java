 ...
 *       &lt;sequence>
 *         &lt;element name="strategy" type="{http://taverna.sf.net/2008/xml/t2flow}TopIterationNode" maxOccurs="unbounded" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
public class Iteration {
    ...
    protected List<TopIterationNode> strategy;
     ...
     * {@link TopIterationNode }
     * 
     * 
     */
    public List<TopIterationNode> getStrategy() {
        if (strategy == null) {
            strategy = new ArrayList<TopIterationNode>();
        }
