 ...
 *       &lt;sequence>
 *         &lt;element ref="{http://org.embl.ebi.escience/xscufl/0.1alpha}default" maxOccurs="unbounded" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
public class DefaultsType {
    ...
    protected List<DefaultType> _default;
     ...
     * 
     */
    public List<DefaultType> getDefault() {
        if (_default == null) {
            _default = new ArrayList<DefaultType>();
        }
